...
# Registrar información en Neptune
    neptune_run["directory/current_path"].log(current_dir)
    neptune_run["directory/parent_path"].log(parent_dir)
    neptune_run["directory/current_files"].log(current_dir_files)
    neptune_run["directory/parent_files"].log(parent_dir_files)
#    pwd=os.getcwd()
#    neptune_run["directory"].log(pwd)
   # model = utils.load_weights(
    #    model, 
   ...
   # )
    ...
    best_checkpoint_path = "best_checkpoint.pytorch"
    torch.save(model.state_dict(), best_checkpoint_path)

    # Upload the checkpoint to Neptune
    neptune_run["model/checkpoint"].upload(best_checkpoint_path)
#    run_id = neptune_run.id
